...
class EasyApplyBot:
    setupLogger()
    # MAX_SEARCH_TIME is 1 hours by default, feel free to modify it
    ...
    def fill_data(self):
        self.browser.set_window_size(785, 585)
    ...
    def applications_loop(self, position, location):
        ...
        while time.time() - start_time < self.MAX_SEARCH_TIME:
            ...
            for i, jobID in enumerate(jobIDs):
                ...
                # sleep every 10 applications
                if count_application != 0 and count_application % 10 == 0:
    ...
    def avoid_lock(self):
        ...
        time.sleep(0.5)
        pyautogui.press('esc')
# https://www.linkedin.com/jobs/search/?f_AL=true&f_E=1%2C2%2C3%2C4&f_TPR=r604800&geoId=106155005&keywords=javascript%20developer&location=Egypt
    def next_jobs_page(self, position, location, jobs_per_page):
        self.browser.get(
            "https://www.linkedin.com/jobs/search/?f_AL=true&keywords=" +
